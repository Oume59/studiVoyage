        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/Sejour">Séjours</a></li>
                    <li class="nav-item"><a class="nav-link" href="/Circuit">Circuits</a></li>
                    <li class="nav-item"><a class="nav-link" href="/Croisiere">Croisières</a></li>
                    <li class="nav-item"><a class="nav-link" href="/DerniereMinute">Dernières Minutes</a></li>
                    <li class="nav-item"><a class="nav-link" href="/Promotion">Promotions</a></li>

                    <?php if (isset($_SESSION['id'])): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="/log/logout" onclick="return confirm('Etes-vous sûr de vouloir vous déconnecter ?');">
                                Déconnexion
                            </a>
                        </li>
                    <?php else: ?>
                        <li class="nav-item"><a class="nav-link" href="/log">Connexion</a></li>
                    <?php endif; ?>
